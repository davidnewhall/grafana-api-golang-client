...
func (c *Client) GetDashboardVersions(dashboardUID string, limit, start int) ([]*DashboardVersion, error) {
	return c.GetDashboardVersionsContext(context.Background(), dashboardUID, limit, start)
}

// GetDashboardVersionsContext does the same thing as GetDashboardVersions(), but also takes in a context.
func (c *Client) GetDashboardVersionsContext(ctx context.Context, dashboardUID string, limit, start int) ([]*DashboardVersion, error) {
	var (
	...
	if err := c.request(ctx, http.MethodGet, path, params, nil, &result); err != nil {
		return nil, err
	}
...
func (c *Client) GetDashboardVersion(dashboardUID string, version int) (*DashboardVersion, error) {
	return c.GetDashboardVersionContext(context.Background(), dashboardUID, version)
}

// GetDashboardVersionContext does the same thing as GetDashboardVersion(), but also takes in a context.
func (c *Client) GetDashboardVersionContext(ctx context.Context, dashboardUID string, version int) (*DashboardVersion, error) {
	var (
		params = make(url.Values)
		result = DashboardVersion{}
...
func (c *Client) RestoreDashboardVersion(dashboardUID string, version int) (*DashboardVersionRestore, error) {
	return c.RestoreDashboardVersionContext(context.Background(), dashboardUID, version)
}

// RestoreDashboardVersionContext does the same thing as RestoreDashboardVersion(), but also takes in a context.
func (c *Client) RestoreDashboardVersionContext(ctx context.Context, dashboardUID string, version int) (*DashboardVersionRestore, error) {
	var (
		params = make(url.Values)
	...
	if err := c.request(ctx, http.MethodPost, path, params, body, &result); err != nil {
		return nil, err
	}
...
func (c *Client) CompareDashboardVersions(compareDashboards CompareDashboardsInput) ([]byte, error) {
	return c.CompareDashboardVersionsContext(context.Background(), compareDashboards)
}

func (c *Client) CompareDashboardVersionsContext(ctx context.Context, compareDashboards CompareDashboardsInput) ([]byte, error) {
	var body bytes.Buffer
	if err := json.NewEncoder(&body).Encode(compareDashboards); err != nil {
		return nil, fmt.Errorf("json encoding input: %w", err)
	}

	req, err := c.newRequest(ctx, http.MethodPost, "/api/dashboards/calculate-diff", url.Values{}, &body)
	if err != nil {
